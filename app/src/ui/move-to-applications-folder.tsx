...
> {
  ...
  public render() {
    return (
      <Dialog
        title="Move GITmaxed to the Applications folder?"
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle="This will move GITmaxed to the Applications folder in your machine and restart the app."
