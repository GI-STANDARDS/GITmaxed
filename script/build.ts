...
function packageApp() {
  ...
  return packager({
    ...
    appCopyright: `Copyright © ${new Date().getFullYear()} GITmaxed Contributors.`,
    ...
    win32metadata: {
      ...
      FileDescription: 'The Multiaccount GitHub Extension',
...
function generateLicenseMetadata(outRoot: string) {
  ...
  const licenseWithHeader = `GITmaxed uses licensing information provided by choosealicense.com.
